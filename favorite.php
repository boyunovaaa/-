                    ...
                    <div class="container2">
                        ...
                        <ul class="products-list">
                            <?php 
                                ...
                                $sql = mysqli_query($conn, 'SELECT zoo2.Kind, zoo3.CageLocation FROM ((favorites JOIN zoo2 ON favorites.id_animal=zoo2.id) JOIN zoo3 ON zoo2.NoCageLocation=zoo3.id) WHERE favorites.id_user="'.$_SESSION['auth'].'"');
                                ...
                                if($count==0){
                                    echo '<h3>Нет избранных животных</h3>';
                                }
